...
import pb2.auth.auth_pb2 as auth__pb2
...
class AuthStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.AuthOrCreate = channel.unary_unary(
                '/auth.Auth/AuthOrCreate',
...
class AuthServicer(object):
    ...
    def AuthOrCreate(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_AuthServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AuthOrCreate': grpc.unary_unary_rpc_method_handler(
                    servicer.AuthOrCreate,
